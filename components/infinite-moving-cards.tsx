  ...
  return (
    ...
    >
      ...
      >
        {items.map((item, idx) => (
          <li
            className="w-[350px] max-w-full relative rounded-2xl border border-border flex-shrink-0 px-8 py-6 md:w-[450px] glass"
            key={idx}
          >
            <blockquote>
              <div
              ...
              ></div>
              <span className="relative z-20 text-sm leading-[1.6] text-foreground/80 font-normal">
                {'"'}
                {item.quote}
                {'"'}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center gap-3">
                ...
                <span className="flex flex-col gap-1">
                  <span className="text-sm leading-[1.6] text-foreground font-medium">{item.name}</span>
