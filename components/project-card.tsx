...
export function ProjectCard({ project, index, isInView }: ProjectCardProps) {
  ...
  return (
    <motion.div
      ...
      className={`group relative overflow-hidden rounded-2xl glass transition-all duration-700 flex basis-full flex-col tracking-tight text-slate-100/50 w-[18rem] h-72 lg:w-100 md:w-80 md:h-80 lg:h-100 ${
